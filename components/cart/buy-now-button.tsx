...
function BuyNowButton({
    ...
    const buttonClasses =
        "relative flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-br from-[#6b1414] via-[#8b1a1a] to-[#6b1414] p-4 tracking-wide text-white font-body font-bold text-lg shadow-[0_4px_16px_rgba(107,20,20,0.3)] transition-all duration-300";
